...
import { deleteRow, flightBookingActions } from "../redux/booking/actions";

const Content = () => {
  const selector = useSelector((state) => state.booking.value);
  ...
  const handleSubmit = (e) => {
    ...
    if (selector.length > 2) {
      return alert("You have already booked");
    }
    return dispatch(flightBookingActions(data));
  };
        ...
        <table className="booking-table">
          ...
          <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
            {selector.map((item, i) => {
              return (
                <>
                  <tr className="lws-bookedTable text-black" key={i}>
